...
public class OutputThread extends Thread {
     ...
     */
    OutputThread(pl.quider.standalone.irc.protocol.PircBot bot, Queue outQueue) {
        _bot = bot;
        _outQueue = outQueue;
     ...
     *                 byte array.
     */
    static void sendRawLine(pl.quider.standalone.irc.protocol.PircBot bot, BufferedWriter bwriter, String line) {
