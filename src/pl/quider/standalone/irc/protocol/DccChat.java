...
public class DccChat {
     ...
     */
    DccChat(pl.quider.standalone.irc.protocol.PircBot bot, String nick, String login, String hostname, long address, int port) {
        _bot = bot;
        _address = address;
        _port = port;
        _nick = nick;
     ...
     */
    DccChat(pl.quider.standalone.irc.protocol.PircBot bot, String nick, Socket socket) throws IOException {
        _bot = bot;
        _nick = nick;
        _socket = socket;
