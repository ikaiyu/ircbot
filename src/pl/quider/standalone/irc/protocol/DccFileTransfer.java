...
public class DccFileTransfer {
     ...
     */
    DccFileTransfer(pl.quider.standalone.irc.protocol.PircBot bot, DccManager manager, String nick, String login, String hostname, String type, String filename, long address, int port, long size) {
        _bot = bot;
        _manager = manager;
        _nick = nick;
        _login = login;
     ...
     */
    DccFileTransfer(pl.quider.standalone.irc.protocol.PircBot bot, DccManager manager, File file, String nick, int timeout) {
        _bot = bot;
        _manager = manager;
        _nick = nick;
        _file = file;
        ...
        new Thread() {
            public void run() {
                ...
                try {
                    ...
                    _manager.removeAwaitingResume(pl.quider.standalone.irc.protocol.DccFileTransfer.this);
                ...
                _bot.onFileTransferFinished(pl.quider.standalone.irc.protocol.DccFileTransfer.this, exception);
            }
        }.start();
    }
        ...
        new Thread() {
            public void run() {
                ...
                try {
                    ...
                    if (allowResume) {
                        _manager.addAwaitingResume(pl.quider.standalone.irc.protocol.DccFileTransfer.this);
                    }
